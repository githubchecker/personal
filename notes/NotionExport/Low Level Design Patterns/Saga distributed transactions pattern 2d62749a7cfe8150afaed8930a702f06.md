...
Microservices architectures typically assign a [dedicated database to each microservice](https://learn.microsoft.com/en-us/dotnet/architecture/cloud-native/distributed-data#database-per-microservice-why). This approach provides several benefits:
...
![Diagram that shows a saga overview.](https://learn.microsoft.com/en-us/azure/architecture/patterns/_images/saga-overview.png)
