...
* In the **Create a new project** dialog:
  ...
  ![Visual Studio Create a new project](https://learn.microsoft.com/en-us/aspnet/core/min-web-api/_static/9.x/create-new-project-empty-vs17.11.0.png?view=aspnetcore-10.0)
...
* In the **Additional information** dialog:
  ...
  ![Additional information](https://learn.microsoft.com/en-us/aspnet/core/min-web-api/_static/9.x/add-info-vs17.11.0.png?view=aspnetcore-10.0)
...
![This project is configured to use SSL. To avoid SSL warnings in the browser you can choose to trust the self-signed certificate that IIS Express has generated. Would you like to trust the IIS Express SSL certificate?](https://learn.microsoft.com/en-us/aspnet/static/trustcertvs22.png?view=aspnetcore-10.0)
...
Visual Studio launches the [Kestrel web server](https://learn.microsoft.com/en-us/aspnet/fundamentals/servers/kestrel?view=aspnetcore-10.0) and opens a browser window.
...
The following highlighted code adds the database context to the [dependency injection (DI)](https://learn.microsoft.com/en-us/aspnet/fundamentals/dependency-injection?view=aspnetcore-10.0) container and enables displaying database-related exceptions:
...
* Right-click the **POST** endpoint and select **Generate request**.
  ...
  ![Endpoints Explorer context menu highlighting Generate Request menu item.](https://learn.microsoft.com/en-us/aspnet/core/min-web-api/_static/9.x/generate-request-vs17.8.0.png?view=aspnetcore-10.0)
...
* Select the **Send request** link that is above the  `POST`  request line.
  ...
  ![.http file window with run link highlighted.](https://learn.microsoft.com/en-us/aspnet/core/min-web-api/_static/9.x/http-file-run-button-vs17.8.0.png?view=aspnetcore-10.0)

  The POST request is sent to the app and the response is displayed in the **Response** pane.

  ![.http file window with response from the POST request.](https://learn.microsoft.com/en-us/aspnet/core/min-web-api/_static/9.x/http-file-window-with-response-vs17.8.0.png?view=aspnetcore-10.0)
...
* With the app still running, in the browser, navigate to  `https://localhost:<port>/swagger`  to display the API testing page generated by Swagger.
  ...
  ![Swagger generated API testing page](https://learn.microsoft.com/en-us/aspnet/core/min-web-api/_static/9.x/swagger.png?view=aspnetcore-10.0)
...
* Select **Execute**.
  ...
  ![Swagger with Post request](https://learn.microsoft.com/en-us/aspnet/core/min-web-api/_static/9.x/swagger-post-1.png?view=aspnetcore-10.0)

Swagger provides a **Responses** pane below the **Execute** button.

![Swagger with Post resonse](https://learn.microsoft.com/en-us/aspnet/core/min-web-api/_static/9.x/swagger-post-responses.png?view=aspnetcore-10.0)
...
This app uses an in-memory database. If the app is restarted, the GET request doesn't return any data. If no data is returned, [POST](https://learn.microsoft.com/en-us/aspnet/core/#post) data to the app and try the GET request again.
...
If you run into a problem you can't resolve, compare your code to the completed project. [View or download completed project](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/tutorials/min-web-api/samples) ([how to download](https://learn.microsoft.com/en-us/aspnet/fundamentals/?view=aspnetcore-10.0#how-to-download-a-sample)).

## Next steps

* [Configure JSON serialization options](https://learn.microsoft.com/en-us/aspnet/fundamentals/minimal-apis/responses?view=aspnetcore-10.0#configure-json-serialization-options).
* Handle errors and exceptions: The [developer exception page](https://learn.microsoft.com/en-us/aspnet/fundamentals/error-handling-api?view=aspnetcore-10.0#developer-exception-page) is enabled by default in the  `Development`  environment for Minimal API apps. For information about how to handle errors and exceptions, see [Handle errors in ASP.NET Core APIs](https://learn.microsoft.com/en-us/aspnet/fundamentals/error-handling-api?view=aspnetcore-10.0).
...
* [OpenAPI support in Minimal APIs](https://learn.microsoft.com/en-us/aspnet/fundamentals/openapi/aspnetcore-openapi?view=aspnetcore-10.0).
...
See [Minimal APIs quick reference](https://learn.microsoft.com/en-us/aspnet/fundamentals/minimal-apis?view=aspnetcore-10.0)
