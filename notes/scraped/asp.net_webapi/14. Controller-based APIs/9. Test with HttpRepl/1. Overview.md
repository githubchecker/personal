...
* [DELETE](https://learn.microsoft.com/en-us/aspnet/core/#test-http-delete-requests)
* [GET](https://learn.microsoft.com/en-us/aspnet/core/#test-http-get-requests)
* [HEAD](https://learn.microsoft.com/en-us/aspnet/core/#test-http-head-requests)
* [OPTIONS](https://learn.microsoft.com/en-us/aspnet/core/#test-http-options-requests)
* [PATCH](https://learn.microsoft.com/en-us/aspnet/core/#test-http-patch-requests)
* [POST](https://learn.microsoft.com/en-us/aspnet/core/#test-http-post-requests)
* [PUT](https://learn.microsoft.com/en-us/aspnet/core/#test-http-put-requests)

To follow along, [view or download the sample ASP.NET Core web API](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/web-api/http-repl/samples) ([how to download](https://learn.microsoft.com/en-us/fundamentals/?view=aspnetcore-10.0#how-to-download-a-sample)).
...
A [.NET Global Tool](https://learn.microsoft.com/en-us/dotnet/core/tools/global-tools#install-a-global-tool) is installed from the [Microsoft.dotnet-httprepl](https://www.nuget.org/packages/Microsoft.dotnet-httprepl) NuGet package.
...
The HttpRepl's default [colors](https://learn.microsoft.com/en-us/aspnet/core/#set-color-preferences) can be customized. Additionally, a [default text editor](https://learn.microsoft.com/en-us/aspnet/core/#set-the-default-text-editor) can be defined. The HttpRepl preferences are persisted across the current session and are honored in future sessions. Once modified, the preferences are stored in the following file:
...
Response colorization is currently supported for JSON only. To customize the default HttpRepl tool coloring, locate the key corresponding to the color to be changed. For instructions on how to find the keys, see the [View the settings](https://learn.microsoft.com/en-us/aspnet/core/#view-the-settings) section. For example, change the  `colors.json`  key value from  `Green`  to  `White`  as follows:
...
* [Linux](https://learn.microsoft.com/en-us/aspnet/core/#tabpanel_2_linux)
* [macOS](https://learn.microsoft.com/en-us/aspnet/core/#tabpanel_2_macos)
* [Windows](https://learn.microsoft.com/en-us/aspnet/core/#tabpanel_2_windows)
...
1. Run the  `post`  command on an endpoint that supports it:
   ...
   > [!TIP]
   > To set the default text editor, see the [Set the default text editor](https://learn.microsoft.com/en-us/aspnet/core/#set-the-default-text-editor) section.
