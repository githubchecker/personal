...
The [HttpRepl](https://learn.microsoft.com/en-us/aspnet/core/?view=aspnetcore-10.0) includes a telemetry feature that collects usage data. It's important that the HttpRepl team understands how the tool is used so it can be improved.
