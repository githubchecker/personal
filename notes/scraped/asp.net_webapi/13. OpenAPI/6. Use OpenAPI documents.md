...
* Enable the swagger-ui middleware with a reference to the [OpenAPI route registered earlier](https://learn.microsoft.com/en-us/aspnet/core/aspnetcore-openapi?view=aspnetcore-10.0#customize-the-openapi-endpoint-route).
...
â 5 problems (0 errors, 5 warnings, 0 infos, 0 hints)
```

## Support for injecting `IOpenApiDocumentProvider`

You can inject [IOpenApiDocumentProvider](https://learn.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.openapi.iopenapidocumentprovider) into your services through dependency injection to access OpenAPI documents programmatically, even outside HTTP request contexts.
