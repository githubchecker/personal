...
<!-- SOURCE: 1. Document.md -->

Here we’ll learn to manipulate a web-page using JavaScript.

1. [Browser environment, specs](/browser-environment)
2. [DOM tree](/dom-nodes)
3. [Walking the DOM](/dom-navigation)
4. [Searching: getElement\*, querySelector\*](/searching-elements-dom)
5. [Node properties: type, tag and contents](/basic-dom-node-properties)
6. [Attributes and properties](/dom-attributes-and-properties)
7. [Modifying the document](/modifying-document)
8. [Styles and classes](/styles-and-classes)
9. [Element size and scrolling](/size-and-scroll)
10. [Window sizes and scrolling](/size-and-scroll-window)
11. [Coordinates](/coordinates)

---

<!-- SOURCE: 1. Browser environment, specs.md -->
...
![](/article/browser-environment/windowObjects.svg)
...
## [DOM (Document Object Model)](/browser-environment#dom-document-object-model)
...
## [BOM (Browser Object Model)](/browser-environment#bom-browser-object-model)
...
## [An example of the DOM](/dom-nodes#an-example-of-the-dom)
...
## [Autocorrection](/dom-nodes#autocorrection)
...
## [Other node types](/dom-nodes#other-node-types)
...
## [See it for yourself](/dom-nodes#see-it-for-yourself)
...
## [Interaction with console](/dom-nodes#interaction-with-console)
...
![](/article/dom-nodes/domconsole0.svg)
...
![](/article/dom-nodes/domconsole1.svg)
...
![](/article/dom-navigation/dom-links.svg)

Let’s discuss them in more detail.

## [On top: documentElement and body](/dom-navigation#on-top-documentelement-and-body)
...
## [Children: childNodes, firstChild, lastChild](/dom-navigation#children-childnodes-firstchild-lastchild)
...
### [DOM collections](/dom-navigation#dom-collections)
...
## [Siblings and the parent](/dom-navigation#siblings-and-the-parent)
...
## [Element-only navigation](/dom-navigation#element-only-navigation)
...
![](/article/dom-navigation/dom-links-elements.svg)
...
## [More links: tables](/dom-navigation#dom-navigation-tables)
...
## [Summary](/dom-navigation#summary)
...
<!-- SOURCE: 4. Searching getElement, querySelector.md -->

DOM navigation properties are great when elements are close to each other. What if they are not? How to get an arbitrary element of the page?

There are additional searching methods for that.

## [document.getElementById or just id](/searching-elements-dom#document-getelementbyid-or-just-id)
...
## [querySelectorAll](/searching-elements-dom#querySelectorAll)
...
## [querySelector](/searching-elements-dom#querySelector)

The call to `elem.querySelector(css)` returns the first element for the given CSS selector.

In other words, the result is the same as `elem.querySelectorAll(css)[0]`, but the latter is looking for *all* elements and picking one, while `elem.querySelector` just looks for one. So it’s faster and also shorter to write.

## [matches](/searching-elements-dom#matches)
...
## [closest](/searching-elements-dom#closest)
...
## [getElementsBy\*](/searching-elements-dom#getelementsby)
...
## [Live collections](/searching-elements-dom#live-collections)
...
## [Summary](/searching-elements-dom#summary)
...
<!-- SOURCE: 5. Node properties type, tag and contents.md -->

Let’s get a more in-depth look at DOM nodes.

In this chapter we’ll see more into what they are and learn their most used properties.

## [DOM node classes](/basic-dom-node-properties#dom-node-classes)
...
![](/article/basic-dom-node-properties/dom-class-hierarchy.svg)
...
## [The “nodeType” property](/basic-dom-node-properties#the-nodetype-property)
...
## [Tag: nodeName and tagName](/basic-dom-node-properties#tag-nodename-and-tagname)
...
## [innerHTML: the contents](/basic-dom-node-properties#innerhtml-the-contents)
...
### [Beware: “innerHTML+=” does a full overwrite](/basic-dom-node-properties#beware-innerhtml-does-a-full-overwrite)
...
## [outerHTML: full HTML of the element](/basic-dom-node-properties#outerhtml-full-html-of-the-element)
...
## [nodeValue/data: text node content](/basic-dom-node-properties#nodevalue-data-text-node-content)
...
## [textContent: pure text](/basic-dom-node-properties#textcontent-pure-text)
...
## [The “hidden” property](/basic-dom-node-properties#the-hidden-property)
...
## [More properties](/basic-dom-node-properties#more-properties)
...
## [Summary](/basic-dom-node-properties#summary)
...
<!-- SOURCE: 6. Attributes and properties.md -->
...
## [DOM properties](/dom-attributes-and-properties#dom-properties)
...
## [HTML attributes](/dom-attributes-and-properties#html-attributes)
...
## [Property-attribute synchronization](/dom-attributes-and-properties#property-attribute-synchronization)
...
## [DOM properties are typed](/dom-attributes-and-properties#dom-properties-are-typed)
...
## [Non-standard attributes, dataset](/dom-attributes-and-properties#non-standard-attributes-dataset)
...
## [Summary](/dom-attributes-and-properties#summary)
...
<!-- SOURCE: 7. Modifying the document.md -->

DOM modification is the key to creating “live” pages.

Here we’ll see how to create new elements “on the fly” and modify the existing page content.

## [Example: show a message](/modifying-document#example-show-a-message)
...
## [Creating an element](/modifying-document#creating-an-element)
...
### [Creating the message](/modifying-document#creating-the-message)
...
## [Insertion methods](/modifying-document#insertion-methods)
...
![](/article/modifying-document/before-prepend-append-after.svg)
...
## [insertAdjacentHTML/Text/Element](/modifying-document#insertadjacenthtml-text-element)
...
![](/article/modifying-document/insert-adjacent.svg)
...
## [Node removal](/modifying-document#node-removal)
...
## [Cloning nodes: cloneNode](/modifying-document#cloning-nodes-clonenode)
...
## [DocumentFragment](/modifying-document#document-fragment)
...
## [Old-school insert/remove methods](/modifying-document#old-school-insert-remove-methods)
...
## [A word about “document.write”](/modifying-document#a-word-about-document-write)
...
## [Summary](/modifying-document#summary)
...
<!-- SOURCE: 8. Styles and classes.md -->
...
## [className and classList](/styles-and-classes#classname-and-classlist)
...
## [Element style](/styles-and-classes#element-style)
...
## [Resetting the style property](/styles-and-classes#resetting-the-style-property)
...
## [Mind the units](/styles-and-classes#mind-the-units)
...
## [Computed styles: getComputedStyle](/styles-and-classes#computed-styles-getcomputedstyle)
...
## [Summary](/styles-and-classes#summary)
...
<!-- SOURCE: 9. Element size and scrolling.md -->

There are many JavaScript properties that allow us to read information about element width, height and other geometry features.

We often need them when moving or positioning elements in JavaScript.

## [Sample element](/size-and-scroll#sample-element)
...
![](/article/size-and-scroll/metric-css.svg)

You can [open the document in the sandbox](https://plnkr.co/edit/xPOfAnuT7lGQc7dP?p=preview).
...
## [Geometry](/size-and-scroll#geometry)

Here’s the overall picture with geometry properties:

![](/article/size-and-scroll/metric-all.svg)

Values of these properties are technically numbers, but these numbers are “of pixels”, so these are pixel measurements.

Let’s start exploring the properties starting from the outside of the element.

## [offsetParent, offsetLeft/Top](/size-and-scroll#offsetparent-offsetleft-top)
...
![](/article/size-and-scroll/metric-offset-parent.svg)
...
## [offsetWidth/Height](/size-and-scroll#offsetwidth-height)

Now let’s move on to the element itself.

These two properties are the simplest ones. They provide the “outer” width/height of the element. Or, in other words, its full size including borders.

![](/article/size-and-scroll/metric-offset-width-height.svg)
...
## [clientTop/Left](/size-and-scroll#clienttop-left)
...
![](/article/size-and-scroll/metric-client-left-top.svg)
...
![](/article/size-and-scroll/metric-client-left-top-rtl.svg)

## [clientWidth/Height](/size-and-scroll#clientwidth-height)

These properties provide the size of the area inside the element borders.

They include the content width together with paddings, but without the scrollbar:

![](/article/size-and-scroll/metric-client-width-height.svg)
...
![](/article/size-and-scroll/metric-client-width-nopadding.svg)

So when there’s no padding we can use `clientWidth/clientHeight` to get the content area size.

## [scrollWidth/Height](/size-and-scroll#scrollwidth-height)

These properties are like `clientWidth/clientHeight`, but they also include the scrolled out (hidden) parts:

![](/article/size-and-scroll/metric-scroll-width-height.svg)
...
## [scrollLeft/scrollTop](/size-and-scroll#scrollleft-scrolltop)

Properties `scrollLeft/scrollTop` are the width/height of the hidden, scrolled out part of the element.

On the picture below we can see `scrollHeight` and `scrollTop` for a block with a vertical scroll.

![](/article/size-and-scroll/metric-scroll-top.svg)
...
## [Don’t take width/height from CSS](/size-and-scroll#don-t-take-width-height-from-css)
...
## [Summary](/size-and-scroll#summary)
...
<!-- SOURCE: 10. Window sizes and scrolling.md -->
...
## [Width/height of the window](/size-and-scroll-window#width-height-of-the-window)

To get window width and height, we can use the `clientWidth/clientHeight` of `document.documentElement`:

![](/article/size-and-scroll-window/document-client-width-height.svg)
...
## [Width/height of the document](/size-and-scroll-window#width-height-of-the-document)
...
## [Get the current scroll](/size-and-scroll-window#page-scroll)
...
## [Scrolling: scrollTo, scrollBy, scrollIntoView](/size-and-scroll-window#window-scroll)
...
## [scrollIntoView](/size-and-scroll-window#scrollintoview)
...
## [Forbid the scrolling](/size-and-scroll-window#forbid-the-scrolling)
...
## [Summary](/size-and-scroll-window#summary)
...
![](/article/coordinates/document-and-window-coordinates-scrolled.svg)
...
## [Element coordinates: getBoundingClientRect](/coordinates#element-coordinates-getboundingclientrect)
...
![](/article/coordinates/coordinates.svg)
...
![](/article/coordinates/coordinates-negative.svg)
...
## [elementFromPoint(x, y)](/coordinates#elementFromPoint)
...
## [Using for “fixed” positioning](/coordinates#using-for-fixed-positioning)
...
## [Document coordinates](/coordinates#getCoords)
...
<!-- SOURCE: 2. Introduction to Events.md -->

An introduction to browser events, event properties and handling patterns.

1. [Introduction to browser events](/introduction-browser-events)
2. [Bubbling and capturing](/bubbling-and-capturing)
3. [Event delegation](/event-delegation)
4. [Browser default actions](/default-browser-action)
5. [Dispatching custom events](/dispatch-events)

---

<!-- SOURCE: 1. Introduction to browser events.md -->
...
## [Event handlers](/introduction-browser-events#event-handlers)
...
### [HTML-attribute](/introduction-browser-events#html-attribute)
...
### [DOM property](/introduction-browser-events#dom-property)
...
## [Accessing the element: this](/introduction-browser-events#accessing-the-element-this)
...
## [Possible mistakes](/introduction-browser-events#possible-mistakes)
...
## [addEventListener](/introduction-browser-events#addeventlistener)
...
## [Event object](/introduction-browser-events#event-object)
...
## [Object handlers: handleEvent](/introduction-browser-events#object-handlers-handleevent)
...
## [Summary](/introduction-browser-events#summary)
...
<!-- SOURCE: 2. Bubbling and capturing.md -->
...
## [Bubbling](/bubbling-and-capturing#bubbling)
...
![](/article/bubbling-and-capturing/event-order-bubbling.svg)
...
## [event.target](/bubbling-and-capturing#event-target)
...
[https://plnkr.co/edit/vh3plE2ZelF0xKaI?p=preview](https://plnkr.co/edit/vh3plE2ZelF0xKaI?p=preview)
...
## [Stopping bubbling](/bubbling-and-capturing#stopping-bubbling)
...
## [Capturing](/bubbling-and-capturing#capturing)
...
![](/article/bubbling-and-capturing/eventflow.svg)
...
![](/article/event-delegation/bagua-bubble.svg)
...
## [Delegation example: actions in markup](/event-delegation#delegation-example-actions-in-markup)
...
## [The “behavior” pattern](/event-delegation#the-behavior-pattern)
...
### [Behavior: Counter](/event-delegation#behavior-counter)
...
### [Behavior: Toggler](/event-delegation#behavior-toggler)
...
<!-- SOURCE: 4. Browser default actions.md -->
...
## [Preventing browser actions](/default-browser-action#preventing-browser-actions)
...
### [Example: the menu](/default-browser-action#example-the-menu)
...
## [The “passive” handler option](/default-browser-action#the-passive-handler-option)
...
## [event.defaultPrevented](/default-browser-action#event-defaultprevented)
...
## [Summary](/default-browser-action#summary)
...
<!-- SOURCE: 5. Dispatching custom events.md -->
...
## [Event constructor](/dispatch-events#event-constructor)
...
## [dispatchEvent](/dispatch-events#dispatchevent)
...
## [Bubbling example](/dispatch-events#bubbling-example)
...
## [MouseEvent, KeyboardEvent and others](/dispatch-events#mouseevent-keyboardevent-and-others)
...
## [Custom events](/dispatch-events#custom-events)
...
## [event.preventDefault()](/dispatch-events#event-preventdefault)
...
## [Events-in-events are synchronous](/dispatch-events#events-in-events-are-synchronous)
...
<!-- SOURCE: 3. UI Events.md -->

Here we cover most important user interface events and how to work with them.

1. [Mouse events](/mouse-events-basics)
2. [Moving the mouse: mouseover/out, mouseenter/leave](/mousemove-mouseover-mouseout-mouseenter-mouseleave)
3. [Drag'n'Drop with mouse events](/mouse-drag-and-drop)
4. [Pointer events](/pointer-events)
5. [Keyboard: keydown and keyup](/keyboard-events)
6. [Scrolling](/onscroll)

---

<!-- SOURCE: 1. Mouse events.md -->

In this chapter we’ll get into more details about mouse events and their properties.

Please note: such events may come not only from “mouse devices”, but are also from other devices, such as phones and tablets, where they are emulated for compatibility.

## [Mouse event types](/mouse-events-basics#mouse-event-types)
...
## [Events order](/mouse-events-basics#events-order)
...
## [Mouse button](/mouse-events-basics#mouse-button)
...
## [Modifiers: shift, alt, ctrl and meta](/mouse-events-basics#modifiers-shift-alt-ctrl-and-meta)
...
## [Coordinates: clientX/Y, pageX/Y](/mouse-events-basics#coordinates-clientx-y-pagex-y)
...
## [Preventing selection on mousedown](/mouse-events-basics#preventing-selection-on-mousedown)
...
## [Summary](/mouse-events-basics#summary)
...
<!-- SOURCE: 2. Moving the mouse mouseoverout, mouseenterleave.md -->

Let’s dive into more details about events that happen when the mouse moves between elements.

## [Events mouseover/mouseout, relatedTarget](/mousemove-mouseover-mouseout-mouseenter-mouseleave#events-mouseover-mouseout-relatedtarget)

The `mouseover` event occurs when a mouse pointer comes over an element, and `mouseout` – when it leaves.

![](/article/mousemove-mouseover-mouseout-mouseenter-mouseleave/mouseover-mouseout.svg)
...
[https://plnkr.co/edit/Q5TbDaID6JRYxssA?p=preview](https://plnkr.co/edit/Q5TbDaID6JRYxssA?p=preview)
...
## [Skipping elements](/mousemove-mouseover-mouseout-mouseenter-mouseleave#skipping-elements)
...
![](/article/mousemove-mouseover-mouseout-mouseenter-mouseleave/mouseover-mouseout-over-elems.svg)
...
![](/article/mousemove-mouseover-mouseout-mouseenter-mouseleave/mouseover-mouseout-from-outside.svg)
...
[https://plnkr.co/edit/c2fG9NT83rPw0ihZ?p=preview](https://plnkr.co/edit/c2fG9NT83rPw0ihZ?p=preview)
...
## [Mouseout when leaving for a child](/mousemove-mouseover-mouseout-mouseenter-mouseleave#mouseout-when-leaving-for-a-child)
...
![](/article/mousemove-mouseover-mouseout-mouseenter-mouseleave/mouseover-to-child.svg)
...
![](/article/mousemove-mouseover-mouseout-mouseenter-mouseleave/mouseover-bubble-nested.svg)
...
[https://plnkr.co/edit/zmJlk0uczwGHsL9X?p=preview](https://plnkr.co/edit/zmJlk0uczwGHsL9X?p=preview)
...
## [Events mouseenter and mouseleave](/mousemove-mouseover-mouseout-mouseenter-mouseleave#events-mouseenter-and-mouseleave)
...
[https://plnkr.co/edit/udklezIDWV1IG2qO?p=preview](https://plnkr.co/edit/udklezIDWV1IG2qO?p=preview)
...
## [Event delegation](/mousemove-mouseover-mouseout-mouseenter-mouseleave#event-delegation)
...
[https://plnkr.co/edit/WoI1Y7ncvQCLxOy3?p=preview](https://plnkr.co/edit/WoI1Y7ncvQCLxOy3?p=preview)
...
[https://plnkr.co/edit/Kg2uJYEQhPzWhoSu?p=preview](https://plnkr.co/edit/Kg2uJYEQhPzWhoSu?p=preview)
...
## [Summary](/mousemove-mouseover-mouseout-mouseenter-mouseleave#summary)
...
<!-- SOURCE: 3. Drag'n'Drop with mouse events.md -->
...
## [Drag’n’Drop algorithm](/mouse-drag-and-drop#drag-n-drop-algorithm)
...
## [Correct positioning](/mouse-drag-and-drop#correct-positioning)
...
![](/article/mouse-drag-and-drop/ball_shift.svg)
...
## [Potential drop targets (droppables)](/mouse-drag-and-drop#potential-drop-targets-droppables)
...
[https://plnkr.co/edit/ji2fZDV7SsGc3xE8?p=preview](https://plnkr.co/edit/ji2fZDV7SsGc3xE8?p=preview)
...
## [Summary](/mouse-drag-and-drop#summary)
...
## [The brief history](/pointer-events#the-brief-history)
...
## [Pointer event types](/pointer-events#pointer-event-types)
...
## [Pointer event properties](/pointer-events#pointer-event-properties)
...
## [Multi-touch](/pointer-events#multi-touch)
...
## [Event: pointercancel](/pointer-events#event-pointercancel)
...
Let’s say we’re implementing drag’n’drop for a ball, just as in the beginning of the article [Drag'n'Drop with mouse events](/mouse-drag-and-drop).
...
## [Pointer capturing](/pointer-events#pointer-capturing)
...
### [Pointer capturing events](/pointer-events#pointer-capturing-events)
...
<!-- SOURCE: 5. Keyboard keydown and keyup.md -->
...
## [Teststand](/keyboard-events#keyboard-test-stand)
...
[https://plnkr.co/edit/9f4GrXbrIAu4pRnD?p=preview](https://plnkr.co/edit/9f4GrXbrIAu4pRnD?p=preview)
...
## [Keydown and keyup](/keyboard-events#keydown-and-keyup)

The `keydown` events happens when a key is pressed down, and then `keyup` – when it’s released.

### [event.code and event.key](/keyboard-events#event-code-and-event-key)
...
Read the [alphanumeric section of the spec](https://www.w3.org/TR/uievents-code/#key-alphanumeric-section) for more codes, or just press a key in the [teststand](/keyboard-events#keyboard-test-stand) above.
...
![](/article/keyboard-events/us-layout.svg)

![](/article/keyboard-events/german-layout.svg)
...
## [Auto-repeat](/keyboard-events#auto-repeat)

If a key is being pressed for a long enough time, it starts to “auto-repeat”: the `keydown` triggers again and again, and then when it’s released we finally get `keyup`. So it’s kind of normal to have many `keydown` and a single `keyup`.

For events triggered by auto-repeat, the event object has `event.repeat` property set to `true`.

## [Default actions](/keyboard-events#default-actions)
...
## [Prevent scrolling](/onscroll#prevent-scrolling)
...
<!-- SOURCE: 4. Forms, controls.md -->

Special properties and events for forms `<form>` and controls: `<input>`, `<select>` and other.

1. [Form properties and methods](/form-elements)
2. [Focusing: focus/blur](/focus-blur)
3. [Events: change, input, cut, copy, paste](/events-change-input)
4. [Forms: event and method submit](/forms-submit)

---

<!-- SOURCE: 1. Form properties and methods.md -->

Forms and control elements, such as `<input>` have a lot of special properties and events.

Working with forms will be much more convenient when we learn them.

## [Navigation: form and elements](/form-elements#navigation-form-and-elements)
...
## [Backreference: element.form](/form-elements#backreference-element-form)

For any element, the form is available as `element.form`. So a form references all elements, and elements reference the form.

Here’s the picture:

![](/article/form-elements/form-navigation.svg)
...
### [input and textarea](/form-elements#input-and-textarea)
...
### [select and option](/form-elements#select-and-option)
...
The full specification of the `<select>` element is available in the specification [https://html.spec.whatwg.org/multipage/forms.html#the-select-element](https://html.spec.whatwg.org/multipage/forms.html#the-select-element).

### [new Option](/form-elements#new-option)
...
## [References](/form-elements#references)
...
<!-- SOURCE: 2. Focusing focusblur.md -->
...
## [Events focus/blur](/focus-blur#events-focus-blur)
...
## [Methods focus/blur](/focus-blur#methods-focus-blur)
...
## [Allow focusing on any element: tabindex](/focus-blur#allow-focusing-on-any-element-tabindex)
...
## [Delegation: focusin/focusout](/focus-blur#delegation-focusin-focusout)
...
<!-- SOURCE: 3. Events change, input, cut, copy, paste.md -->

Let’s cover various events that accompany data updates.

## [Event: change](/events-change-input#event-change)
...
## [Event: input](/events-change-input#event-input)
...
## [Events: cut, copy, paste](/events-change-input#events-cut-copy-paste)
...
### [Safety restrictions](/events-change-input#safety-restrictions)
...
## [Summary](/events-change-input#summary)
...
<!-- SOURCE: 4. Forms event and method submit.md -->
...
## [Event: submit](/forms-submit#event-submit)
...
## [Method: submit](/forms-submit#method-submit)
...
<!-- SOURCE: 5. Document and resource loading.md -->

1. [Page: DOMContentLoaded, load, beforeunload, unload](/onload-ondomcontentloaded)
2. [Scripts: async, defer](/script-async-defer)
3. [Resource loading: onload and onerror](/onload-onerror)

---

<!-- SOURCE: 1. Page DOMContentLoaded, load, beforeunload, unload.md -->
...
## [DOMContentLoaded](/onload-ondomcontentloaded#domcontentloaded)
...
### [DOMContentLoaded and scripts](/onload-ondomcontentloaded#domcontentloaded-and-scripts)
...
### [DOMContentLoaded and styles](/onload-ondomcontentloaded#domcontentloaded-and-styles)
...
### [Built-in browser autofill](/onload-ondomcontentloaded#built-in-browser-autofill)
...
## [window.onload](/onload-ondomcontentloaded#window-onload)
...
## [window.onunload](/onload-ondomcontentloaded#window-onunload)
...
## [window.onbeforeunload](/onload-ondomcontentloaded#window.onbeforeunload)
...
## [readyState](/onload-ondomcontentloaded#readystate)
...
The working example is [in the sandbox](https://plnkr.co/edit/AhBqQwGWWyqsYyOi?p=preview).
...
## [Summary](/onload-ondomcontentloaded#summary)
...
<!-- SOURCE: 2. Scripts async, defer.md -->
...
<script src="/article/script-async-defer/long.js?speed=1"></script>
...
## [defer](/script-async-defer#defer)
...
<script defer src="/article/script-async-defer/long.js?speed=1"></script>
...
```
<script defer src="/article/script-async-defer/long.js"></script>
<script defer src="/article/script-async-defer/small.js"></script>
```
...
## [async](/script-async-defer#async)
...
<script async src="/article/script-async-defer/long.js"></script>
<script async src="/article/script-async-defer/small.js"></script>
...
## [Dynamic scripts](/script-async-defer#dynamic-scripts)
...
<!-- SOURCE: 3. Resource loading onload and onerror.md -->
...
## [Loading a script](/onload-onerror#loading-a-script)
...
### [script.onload](/onload-onerror#script-onload)
...
### [script.onerror](/onload-onerror#script-onerror)
...
## [Other resources](/onload-onerror#other-resources)
...
## [Crossorigin policy](/onload-onerror#crossorigin-policy)
...
/article/onload-onerror/crossorigin/error.js, 1:1
```
...
## [Summary](/onload-onerror#summary)
...
<!-- SOURCE: 6. Miscellaneous.md -->

1. [Mutation observer](/mutation-observer)
2. [Selection and Range](/selection-range)
3. [Event loop: microtasks and macrotasks](/event-loop)

---

<!-- SOURCE: 1. Mutation observer.md -->

`MutationObserver` is a built-in object that observes a DOM element and fires a callback when it detects a change.

We’ll first take a look at the syntax, and then explore a real-world use case, to see where such thing may be useful.

## [Syntax](/mutation-observer#syntax)
...
## [Usage for integration](/mutation-observer#usage-for-integration)
...
## [Usage for architecture](/mutation-observer#usage-for-architecture)
...
### [Dynamic highlight demo](/mutation-observer#dynamic-highlight-demo)
...
## [Additional methods](/mutation-observer#additional-methods)
...
## [Summary](/mutation-observer#summary)
...
<!-- SOURCE: 2. Selection and Range.md -->
...
### [Selecting the text partially](/selection-range#selecting-the-text-partially)
...
![](/article/selection-range/range-hello-1.svg)

### [Selecting element nodes](/selection-range#selecting-element-nodes)
...
![](/article/selection-range/range-example-p-0-1.svg)
...
![](/article/selection-range/range-example-p-1-3.svg)
...
### [Selecting a bigger fragment](/selection-range#selecting-a-bigger-fragment)

Let’s make a bigger selection in our example, like this:

![](/article/selection-range/range-example-p-2-b-3.svg)
...
## [Range properties](/selection-range#range-properties)

The range object that we created in the example above has following properties:

![](/article/selection-range/range-example-p-2-b-3-range.svg)
...
## [Range selection methods](/selection-range#range-selection-methods)
...
## [Range editing methods](/selection-range#range-editing-methods)
...
## [Selection](/selection-range#selection)
...
![](/article/selection-range/selection-firefox.svg)
...
## [Selection properties](/selection-range#selection-properties)
...
![](/article/selection-range/selection-direction-forward.svg)
...
![](/article/selection-range/selection-direction-backward.svg)

## [Selection events](/selection-range#selection-events)
...
### [Selection tracking demo](/selection-range#selection-tracking-demo)
...
### [Selection copying demo](/selection-range#selection-copying-demo)
...
## [Selection methods](/selection-range#selection-methods)
...
## [Selection in form controls](/selection-range#selection-in-form-controls)
...
### [Example: tracking selection](/selection-range#example-tracking-selection)
...
### [Example: moving cursor](/selection-range#example-moving-cursor)
...
### [Example: modifying selection](/selection-range#example-modifying-selection)
...
### [Example: insert at cursor](/selection-range#example-insert-at-cursor)
...
## [Making unselectable](/selection-range#making-unselectable)
...
## [References](/selection-range#references)

* [DOM spec: Range](https://dom.spec.whatwg.org/#ranges)
* [Selection API](https://www.w3.org/TR/selection-api/#dom-globaleventhandlers-onselectstart)
* [HTML spec: APIs for the text control selections](https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#textFieldSelection)

## [Summary](/selection-range#summary)
...
<!-- SOURCE: 3. Event loop microtasks and macrotasks.md -->
...
![](/article/event-loop/eventLoop.svg)
...
## [Use-case 1: splitting CPU-hungry tasks](/event-loop#use-case-1-splitting-cpu-hungry-tasks)
...
## [Use case 2: progress indication](/event-loop#use-case-2-progress-indication)
...
## [Use case 3: doing something after the event](/event-loop#use-case-3-doing-something-after-the-event)
...
## [Macrotasks and Microtasks](/event-loop#macrotasks-and-microtasks)

Along with *macrotasks*, described in this chapter, there are *microtasks*, mentioned in the chapter [Microtasks](/microtask-queue).
...
![](/article/event-loop/eventLoop-full.svg)
