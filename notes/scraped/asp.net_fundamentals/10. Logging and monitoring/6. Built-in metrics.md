...
[System.Diagnostics.Metrics](https://learn.microsoft.com/en-us/dotnet/api/system.diagnostics.metrics) API. For a listing of metrics based on the older [EventCounters](https://learn.microsoft.com/en-us/dotnet/core/diagnostics/event-counters) API, see [Available counters](https://learn.microsoft.com/en-us/dotnet/core/diagnostics/available-counters).

For information on how to collect, report, enrich, and test with ASP.NET Core metrics, see [ASP.NET Core metrics](https://learn.microsoft.com/en-us/aspnet/core/metrics?view=aspnetcore-10.0).

## `Microsoft.AspNetCore.Components`

The  `Microsoft.AspNetCore.Components`  metrics report information on Razor component route changes and browser events:

* [ `aspnetcore.components.navigation` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorecomponentsnavigation)
* [ `aspnetcore.components.event_handler` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorecomponentsevent_handler)
...
| Name | Instrument Type | Unit (UCUM) | Description |
| --- | --- | --- | --- |
| `aspnetcore.components.event_handler` | Histogram | `s` | Measures the duration of processing browser events, including business logic of the component, excluding the duration of child component event handling. |
...
* [ `aspnetcore.components.update_parameters` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorecomponentsupdate_parameters)
* [ `aspnetcore.components.render_diff` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorecomponentsrender_diff)
...
| Name | Instrument Type | Unit (UCUM) | Description |
| --- | --- | --- | --- |
| `aspnetcore.components.render_diff` | Histogram | `s` | Tracks the duration of rendering batches. |
...
* [ `aspnetcore.components.circuit.active` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorecomponentscircuitactive)
* [ `aspnetcore.components.circuit.connected` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorecomponentscircuitconnected)
* [ `aspnetcore.components.circuit.duration` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorecomponentscircuitduration)
...
* [ `http.server.request.duration` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-httpserverrequestduration)
* [ `http.server.active_requests` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-httpserveractive_requests)
...
The  `Microsoft.AspNetCore.Routing`  metrics report information about [routing HTTP requests](https://learn.microsoft.com/en-us/aspnet/core/fundamentals/routing) to ASP.NET Core endpoints:

* [ `aspnetcore.routing.match_attempts` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcoreroutingmatch_attempts)
...
The  `Microsoft.AspNetCore.Diagnostics`  metrics report diagnostics information from [ASP.NET Core error handling middleware](https://learn.microsoft.com/en-us/aspnet/core/fundamentals/error-handling):

* [ `aspnetcore.diagnostics.exceptions` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorediagnosticsexceptions)
...
| `aspnetcore.diagnostics.handler.type` | string | Full type name of the [ `IExceptionHandler` ](https://learn.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.diagnostics.iexceptionhandler) implementation that handled the exception. | `Contoso.MyHandler` | If the exception was handled by this handler. |
| `exception.type` | string | The full name of exception type. | `System.OperationCanceledException` ;  `Contoso.MyException` | Always |

## `Microsoft.AspNetCore.RateLimiting`

The  `Microsoft.AspNetCore.RateLimiting`  metrics report rate limiting information from [ASP.NET Core rate-limiting middleware](https://learn.microsoft.com/en-us/aspnet/core/performance/rate-limit):

* [ `aspnetcore.rate_limiting.active_request_leases` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorerate_limitingactive_request_leases)
* [ `aspnetcore.rate_limiting.request_lease.duration` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorerate_limitingrequest_leaseduration)
* [ `aspnetcore.rate_limiting.queued_requests` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorerate_limitingqueued_requests)
* [ `aspnetcore.rate_limiting.request.time_in_queue` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorerate_limitingrequesttime_in_queue)
* [ `aspnetcore.rate_limiting.requests` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcorerate_limitingrequests)
...
* [ `aspnetcore.header_parsing.parse_errors` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcoreheader_parsingparse_errors)
* [ `aspnetcore.header_parsing.cache_accesses` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcoreheader_parsingcache_accesses)
...
The  `Microsoft.AspNetCore.Server.Kestrel`  metrics report HTTP connection information from [ASP.NET Core Kestrel web server](https://learn.microsoft.com/en-us/aspnet/core/fundamentals/servers/kestrel):

* [ `kestrel.active_connections` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-kestrelactive_connections)
* [ `kestrel.connection.duration` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-kestrelconnectionduration)
* [ `kestrel.rejected_connections` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-kestrelrejected_connections)
* [ `kestrel.queued_connections` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-kestrelqueued_connections)
* [ `kestrel.queued_requests` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-kestrelqueued_requests)
* [ `kestrel.upgraded_connections` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-kestrelupgraded_connections)
* [ `kestrel.tls_handshake.duration` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-kestreltls_handshakeduration)
* [ `kestrel.active_tls_handshakes` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-kestrelactive_tls_handshakes)
...
The  `Microsoft.AspNetCore.Http.Connections`  metrics report connection information from [ASP.NET Core SignalR](https://learn.microsoft.com/en-us/aspnet/core/signalr/introduction):

* [ `signalr.server.connection.duration` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-signalrserverconnectionduration)
* [ `signalr.server.active_connections` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-signalrserveractive_connections)
...
| `long_polling` | [Long Polling](https://learn.microsoft.com/en-us/archive/msdn-magazine/2012/april/cutting-edge-long-polling-and-signalr) |
...
The  `Microsoft.AspNetCore.Authorization`  metrics report information about [Authorization attempts](https://learn.microsoft.com/en-us/security/authorization/introduction?view=aspnetcore-10.0) in ASP.NET Core apps:
...
The  `Microsoft.AspNetCore.Authentication`  metrics report information about [Authentication](https://learn.microsoft.com/en-us/security/authentication/?view=aspnetcore-10.0) in ASP.NET Core apps:

* [ `aspnetcore.authentication.authenticate.duration` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcoreauthenticationauthenticateduration)
* [ `aspnetcore.authentication.challenges` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcoreauthenticationchallenges)
* [ `aspnetcore.authentication.forbids` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcoreauthenticationforbids)
* [ `aspnetcore.authentication.sign_ins` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcoreauthenticationsign_ins)
* [ `aspnetcore.authentication.sign_outs` ](https://learn.microsoft.com/en-us/aspnet/core/#metric-aspnetcoreauthenticationsign_outs)
