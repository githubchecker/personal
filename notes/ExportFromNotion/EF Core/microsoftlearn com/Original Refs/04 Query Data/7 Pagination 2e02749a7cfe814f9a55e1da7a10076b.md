...
<aside>
ℹ️ **NOTE:** Most SQL databases support a simpler and more efficient version of the above, using row values : WHERE (Date, Id) > (@lastDate, @lastId) . EF Core does not currently support expressing this in LINQ queries, this is tracked by [#26822](https://github.com/dotnet/efcore/issues/26822) .
...
For more information, [see the documentation page on indexes](https://learn.microsoft.com/en-us/ef/core/modeling/indexes).
