...
This UPDATE performs the entire operation in a single roundtrip, without loading or sending any actual data to the database, and without making use of EF's change tracking machinery, which imposes an additional overhead. For more information, see [ExecuteUpdateandExecuteDelete](https://learn.microsoft.com/en-us/ef/core/saving/execute-insert-update-delete).
...
To learn more about the differences between SaveChanges and ExecuteUpdate/ExecuteDelete, see the [Overview page](https://learn.microsoft.com/en-us/ef/core/saving/) on saving data.